...
def log_benchmark_times(
    ...
    """
    model_load_start_time = times["model_load_start_time"]
    model_load_end_time = times["model_load_end_time"]
    image_paths_gather_start_time = times["image_paths_gather_start_time"]
    image_paths_gather_end_time = times["image_paths_gather_end_time"]
    inference_start_time = times["inference_start_time"]
    inference_end_time = times["inference_end_time"]
