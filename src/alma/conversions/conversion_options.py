...
MODEL_CONVERSION_OPTIONS: dict[int, ConversionOption] = {
    ...
    43: ConversionOption(mode="COMPILE_INDUCTOR_MAX_AUTOTUNE+TORCHAO_AUTOQUANT_DEFAULT"),
    44: ConversionOption(mode="COMPILE_INDUCTOR_MAX_AUTOTUNE+TORCHAO_AUTOQUANT_NONDEFAULT"),
    45: ConversionOption(mode="COMPILE_CUDAGRAPHS+TORCHAO_AUTOQUANT_DEFAULT", device_override="CUDA"),  # Works in certain circumstances, depends on weight tensor sizes
    46: ConversionOption(mode="COMPILE_INDUCTOR_MAX_AUTOTUNE+TORCHAO_QUANT_I4_WEIGHT_ONLY"),  # Requires bf16 suuport
